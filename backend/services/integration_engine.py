...
# Project root for loading data files
PROJECT_ROOT = Path(__file__).resolve().parent.parent.parent

# Prediction imports
from agents.detection_agent.prediction_conflict.predictor import ConflictPredictor
from agents.detection_agent.prediction_conflict.feature_engine import TrainState, StationState, NetworkState as PredictionNetworkState
from agents.detection_agent.prediction_conflict.config import PredictionConfig

# Detection imports (using absolute imports)
try:
    from agents.detection_agent.deterministic_detection.state_tracker import StateTracker, NetworkState as DetectionNetworkState
    from agents.detection_agent.deterministic_detection.engine import DetectionEngine, ConflictEmitter
    from agents.detection_agent.deterministic_detection.models import (
...
class IntegrationEngine:
    ...
    def initialize(self, simulation_data_path: Optional[Path] = None) -> None:
        ...
        from agents.detection_agent.deterministic_detection.rules import ALL_RULES
