...
from agents.resolution_agent.mathematical_resolution.conflict_adapter import (
...
def print_resolution_plan(plan, conflict):
    ...
    from agents.resolution_agent.mathematical_resolution.math import ActionValidator
...
def main():
    ...
    #C:\rail-mind-server\agents\resolution_agent\nour.json
    conflicts_path = PROJECT_ROOT / 'agents' / 'resolution_agent' / 'nour.json' 
    if not conflicts_path.exists():
        print(f"\n⚠️ No conflict file found at: {conflicts_path}")
        print(f"   Please ensure nour.json exists in the project.")
        return
